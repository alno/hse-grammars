...
Для внутреннего представления интерпретируемого выражения используется ПОЛИЗ
*/
...
int main(int argc, char ** argv) {
    try {
        ...
        std::cout << "Error parsing: " << err << ", but " << currentLex << " got." << std::endl;
    ...
    //    Operation op = program[i];
    //    std::cout << "{" << op.type << "," << op.data << "}" << std::endl;
    //}
